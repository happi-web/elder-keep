...
# 🔴 UNCOMMENT THESE WHEN YOU PAY FOR ELEVENLABS
...
# 3. Initialize ElevenLabs (COMMENTED OUT FOR NOW)
# eleven = ElevenLabs(api_key=ELEVEN_KEY)  # 🔴 UNCOMMENT LATER
...
# Note: 'update_family_memory' removed because Arthur doesn't teach anymore.
# The Dashboard handles that via the REST endpoint.
...
def text_to_speech(text):
    """
    TEMPORARILY DISABLED: Returns None to skip audio generation.
    """
    return None

    # 🔴 UNCOMMENT ALL OF THIS WHEN YOU PAY
    # try:
                ...
                try:
                    ...
                    # --- B. NORMAL CHAT / ONBOARDING ---
                        ...
                        if mode == "ONBOARDING":
                            ...
                            # Standard Chat - Just answer questions using Context
                            response = chat.send_message(user_text)
                            ai_text = response.text
