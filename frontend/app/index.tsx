...
import { View, Text, TouchableOpacity, Image, Animated, ActivityIndicator, StyleSheet, Alert } from 'react-native';
...
export default function Page() {
  ...
  useEffect(() => {
    ...
    // 2. ✅ HANDLE TEXT (Fallback Mode)
    // This runs when ElevenLabs is off/unpaid so the app doesn't freeze
    WebSocketService.onReceiveText = (text: string) => {
        console.log("📝 Received Text Fallback:", text);
        setStatus('idle'); // STOP THE SPINNER
        setIsCameraOpen(false);
        
        // Show the response in a pop-up
        Alert.alert("Myra says:", text);
    };
